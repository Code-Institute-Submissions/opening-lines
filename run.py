...
def get_highest_ever_score(list_of_players, list_of_scores):
    ...
    for player in range (0, len(list_of_players)):
        if int(list_of_scores[player]) >= int(highest_ever_score[1]):
            highest_ever_score = [list_of_players[player],list_of_scores[player]]
...
def total (turn):
    ...
    highest_ever_score = get_highest_ever_score(list_of_players, list_of_scores)
